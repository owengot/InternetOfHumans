<template>
  <div class="graph">
    ...
    <div class="viewport" v-resize.throttle.250="resize">
      ...
      <slot name="top" :colorGetter="colorGetter" :nodes="graphNodes" :actions="actions"> </slot>
...
const useNameForColor = d => d.title
...
.sunburst svg g {
  ...
  left: 0 !important;
  transform: translate(200px, 150px) scale(0.75) !important;
}
